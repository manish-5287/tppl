...
import { Text, TextInput, Image, View, TouchableOpacity, Keyboard, Alert, SafeAreaView, TouchableWithoutFeedback } from 'react-native';
  ...
  render() {
    ...
    return (
      <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
        <SafeAreaView style={{ backgroundColor: 'white', flex: 1, padding: 3 }}>
          <View style={{
          ...
          <View style={{ backgroundColor: "white", flex: 2 }}>
            ...
            <View style={{ alignSelf: 'center', marginTop: wp(15) }} >
              ...
              <View style={{ overflow: 'hidden', alignSelf: 'center', marginTop: wp(8), borderWidth: wp(0.4), borderColor: 'rgba(0,69,97,.4)', borderRadius: wp(10), width: wp(90), height: wp(11.2), flexDirection: 'row', alignItems: 'center' }}>
